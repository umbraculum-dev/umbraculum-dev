 ...
 *  - `no-restricted-imports` scoped to `packages/platform/ui/src/{ai,charts}/**`:
...
export default [
  ...
  // -------------------------------------------------------------------
  {
    ignores: [
      ...
      // Generated by @umbraculum/brewery-api-client openapi:codegen
      "packages/verticals/brewery/api-client/src/generated/**",
  ...
  //
  //  - `services/api/vitest.config.ts`, `packages/verticals/brewery/beerjson/vitest.config.ts`:
  ...
  //  - `packages/verticals/brewery/core/vitest.config.ts`, `packages/verticals/brewery/core/src/index.d.ts`:
  //    `packages/verticals/brewery/core/` has no `tsconfig.json` at all (structural gap;
  //    out of scope for this lint hotfix — track via follow-up).
  //  - `scripts/check-web-url-segments.ts`: there is no `scripts/`
  //    tsconfig at all (same structural gap as `packages/verticals/brewery/core/`).
  //
      ...
      parserOptions: {
        projectService: {
          allowDefaultProject: [
            ...
            "packages/verticals/brewery/beerjson/vitest.config.ts",
            "packages/verticals/brewery/core/vitest.config.ts",
            "packages/verticals/brewery/core/src/index.d.ts",
  ...
  //
  // Files under `packages/platform/ui/src/ai/**` are consumed by BOTH web
  ...
  // in `packages/platform/ui/src/primitives/{Button,Input}.tsx` that
  // do the right thing on each platform.
  //
  // Brewery-specific BrewCheckbox lives in @umbraculum/brewery-recipes-ui.
  //
  ...
  // -------------------------------------------------------------------
  {
    files: ["packages/platform/ui/src/ai/**/*.{ts,tsx}"],
    rules: {
          ...
          paths: [
            {
              ...
              message:
                "Cross-platform components must use platform-forking primitives: import { Button } from '../primitives/Button', { Input } from '../primitives/Input'. Raw tamagui Button/Input/Checkbox leak accessibilityLabel to the DOM on web. See docs/LINTING.md.",
            },
          ],
        },
      ],
  ...
  {
    files: ["packages/verticals/brewery/recipes-ui/src/charts/**/*.{ts,tsx}"],
    rules: {
      "no-restricted-imports": [
        "error",
        {
          paths: [
            {
              ...
              importNames: ["Button", "Input", "Checkbox"],
              message:
                "Cross-platform chart components must use platform primitives from @umbraculum/ui (Card, Text). Raw tamagui Button/Input/Checkbox leak accessibilityLabel to the DOM on web. See docs/LINTING.md.",
            },
          ],
        },
      ],
  ...
  // -------------------------------------------------------------------
  {
    ...
    settings: {
      ...
      "boundaries/elements": [
        ...
        {
          type: "web-platform-shared-layout",
          pattern: "apps/web/app/_shared-layout/{_components,_lib}/**",
          mode: "full",
        },
        {
        ...
        "error",
        {
          ...
          rules: [
            ...
            },
            {
              ...
              allow: [["web-platform-shared-layout"], ["web-brewery-shared"], ["web-app-shared"]],
            },
            {
              from: [["web-water-segment"]],
              disallow: [
    ...
    rules: {
      ...
      "boundaries/element-types": [
        "error",
        {
          default: "allow",
          message:
            "Package layer violation: ${from.type} must not import ${dependency.type} (RFC-0011 §6; see docs/design/solid-boundaries-eslint-packages-spike.md).",
          rules: [
            {
              from: [["pkg-platform"]],
            ...
            {
              from: [["pkg-vertical"]],
              disallow: [["pkg-vertical", { verticalCode: "!${from.verticalCode}" }]],
            },
          ],
        },
      ],
  ...
  {
    files: ["packages/platform/i18n/src/index.ts"],
    rules: {
      "boundaries/element-types": "off",
    },
  },
  {
    files: ["packages/platform/api-client/**/*.{ts,tsx}"],
    rules: {
      "boundaries/element-types": "off",
    },
  },
