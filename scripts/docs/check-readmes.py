...
FULL_SCOPE_README_PATHS = [
    ...
    "packages/sdk/ai-tool-sdk/README.md",
    "packages/sdk/i18n-keys/README.md",
    "packages/platform/api-client/README.md",
    "packages/verticals/brewery/beerjson/README.md",
    "packages/platform/contracts/README.md",
    "packages/sdk/module-sdk/README.md",
    "packages/platform/rendering/README.md",
    ...
    "packages/platform/test-mcp/README.md",
    "packages/platform/ui/README.md",
    "docs-site/README.md",
]
