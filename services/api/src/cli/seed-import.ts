 ...
 * - docs/modules/verticals/brewery/RAW-MATERIALS-SEEDABLE-SOURCES.md
 * - src/seed/README.md
 */
...
function printHelp() {
  ...
  console.log(
    [
      ...
      "  - Licensing constraints are tracked in docs/modules/verticals/brewery/RAW-MATERIALS-SEEDABLE-SOURCES.md.",
    ].join("\n"),
  );
}
