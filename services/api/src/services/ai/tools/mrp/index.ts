...
import { createMrpProposeOrderAdjustmentTool } from "./proposeOrderAdjustment.js";
...
export function registerMrpTools(registry: AiToolRegistry, prisma: PrismaClient): void {
  ...
  registry.register(createMrpProposeOrderAdjustmentTool(prisma) as unknown as AiTool);
}
