...
The API companion to [`@umbraculum/mrp-contracts`](../../../../../packages/canonical/mrp/contracts/README.md) and the public [canonical MRP surface design](../../../../../docs/design/canonical-mrp-module-surface.md).
