...
- [`packages/modules/automation-contracts/`](../../../../../packages/modules/automation-contracts/) — `MailboxSpec`, `AutomationAdapterDefinition`, `CONTRACT_VERSION`.
- [`packages/modules/module-sdk/`](../../../../../packages/modules/module-sdk/) — `registerModule`.
