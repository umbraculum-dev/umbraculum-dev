...
export class WaterCalcService {
  spargeAcidification(body: Record<string, unknown>) {        const acidType = body['acidType'] as SpargeAcidType;
  ...
  spargeAcidificationManual(body: Record<string, unknown>) {        const acidType = body['acidType'] as SpargeAcidType;
    if (typeof acidType !== "string") {
      throw new BadRequestError("invalid_acid_type", "Body.acidType is required");
    }
  ...
  mashAcidification(body: Record<string, unknown>) {        const acidType = body['acidType'] as SpargeAcidType;
    if (typeof acidType !== "string") {
      throw new BadRequestError("invalid_acid_type", "Body.acidType is required");
    }
  ...
  mashAcidificationManual(body: Record<string, unknown>) {        const acidType = body['acidType'] as SpargeAcidType;
    if (typeof acidType !== "string") {
      throw new BadRequestError("invalid_acid_type", "Body.acidType is required");
    }
  ...
  mashPhEstimate(body: Record<string, unknown>) {        const volumeLiters =
      typeof body['mashWaterVolumeLiters'] === "number"
        ? (body['mashWaterVolumeLiters'])
        : typeof body['volumeLiters'] === "number"
          ? (body['volumeLiters'])
  ...
  mashAcidificationTargetMashPh(body: Record<string, unknown>) {        const acidType = body['acidType'] as SpargeAcidType;
    if (typeof acidType !== "string") {
      throw new BadRequestError("invalid_acid_type", "Body.acidType is required");
    }
  ...
  saltAdditions(body: Record<string, unknown>) {        const volumeLiters = typeof body['volumeLiters'] === "number" ? body['volumeLiters'] : NaN;
    if (!Number.isFinite(volumeLiters) || !(volumeLiters > 0)) {
      throw new BadRequestError("invalid_volume_liters", "Body.volumeLiters must be > 0");
    }
  ...
  mashOverall(body: Record<string, unknown>) {        const mashMode = body['mashMode'] === "manual" ? "manual" : "targetPh";
    const startingAlkalinityPpmCaCO3 =
      typeof body['mashStartingAlkalinityPpmCaCO3'] === "number"
        ? (body['mashStartingAlkalinityPpmCaCO3'])
        : typeof body['startingAlkalinityPpmCaCO3'] === "number"
  ...
  spargeOverall(body: Record<string, unknown>) {        const spargeMode = body['spargeMode'] === "manual" ? "manual" : "targetPh";
    const startingAlkalinityPpmCaCO3 =
      typeof body['startingAlkalinityPpmCaCO3'] === "number"
        ? (body['startingAlkalinityPpmCaCO3'])
  ...
  boilOverall(body: Record<string, unknown>) {        const boilMode = body['boilMode'] === "manual" ? "manual" : "targetPh";
    const startingAlkalinityPpmCaCO3 =
      typeof body['startingAlkalinityPpmCaCO3'] === "number"
        ? (body['startingAlkalinityPpmCaCO3'])
