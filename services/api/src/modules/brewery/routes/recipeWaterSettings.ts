  ...
  zodApp.put(
    ...
    async (req) => {
      ...
      const upserted = await svc.upsert(ctx.userId, ctx.activeWorkspaceId, recipeId, {
        ...
        boilSaltsLastResultJson:
          body["boilSaltsLastResultJson"] !== undefined ? body["boilSaltsLastResultJson"] : undefined,
        ...
        boilOverallLastResultJson:
          body["boilOverallLastResultJson"] !== undefined ? body["boilOverallLastResultJson"] : undefined,
        boilOverallLastCalculatedAt:
          typeof body["boilOverallLastCalculatedAt"] === "string"
            ? new Date(body["boilOverallLastCalculatedAt"])
            : undefined,
      });
