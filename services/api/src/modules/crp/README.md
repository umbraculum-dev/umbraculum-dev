...
The API companion to [`@umbraculum/crp-contracts`](../../../../../packages/canonical/crp/contracts/README.md) and the public [canonical CRP surface design](../../../../../docs/design/canonical-crp-module-surface.md).
