...
import { BREWERY_BEERJSON_EXPORT_TEMPLATE_REF } from "../modules/brewery/documentTemplates.js";
...
describe("recipes export (BeerJSON strict)", () => {
  ...
  it("exports BeerJSON with addition row ids stripped", async () => {
    ...
    expect(String(exp.headers["content-disposition"] ?? "")).toContain("Export-Strict-Test.beerjson.json");
