...
**Energy and forests — named worry, modest action.** Umbraculum is built by humans **and** with AI assistance (§1.2); that stack uses **real electricity** — inference, CI, and tooling — and we do not pretend otherwise. Greenhouse gases and forest erosion matter to us less as a political posture than as **admiration for forests** — North American landscapes and forest ecosystems worldwide — and a **consequent** obligation to act modestly: **[Stripe Climate Commitments](https://docs.stripe.com/climate/commitments)** at **1%** on Stripe-processed sponsorship payouts (Liberapay and Buy Me a Coffee), **one hectare of forest** under active maintenance today, and **local reforestation** scaled to our means as capacity allows. Details and honest limits: [`docs/design/donation-channels.md`](docs/design/donation-channels.md) §9. **Open discussion** on this topic in the community is always welcome — we expect the numbers and trade-offs to improve with public scrutiny.
