...
| GitHub org hosting                | **Done 2026-05-27** — `github.com/umbraculum-dev/umbraculum-dev` (**public** since **2026-06-27**); sister repos `umbraculum-toolset` and `umbraculum-brochure` also **public**. |
...
| Public release                    | **Public alpha ✅ 2026-06-27** — [`v0.0.1-alpha`](https://github.com/umbraculum-dev/umbraculum-dev/releases/tag/v0.0.1-alpha); flip record [`docs/design/public-alpha-flip-day-runbook.md`](docs/design/public-alpha-flip-day-runbook.md) |
| Production surfaces               | **Live + indexed:** [umbraculum.dev](https://umbraculum.dev/) · [docs.umbraculum.dev](https://docs.umbraculum.dev/) · [forum.umbraculum.dev](https://forum.umbraculum.dev/) · [demo.umbraculum.dev](https://demo.umbraculum.dev/) · [umbraculum.dev/support/](https://umbraculum.dev/support/) |
