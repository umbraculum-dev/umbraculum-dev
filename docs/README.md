...
- [`design/ecosystem-case-study-omnis.md`](design/ecosystem-case-study-omnis.md) — **Ecosystem lesson (Omnis).** Complements Adobe → Magento in [`MANIFESTO.md`](../MANIFESTO.md) §2.1: good product, absent community/docs/on-ramp; maps to Umbraculum's non-optional documentation, community, open repos, and free-try commitments.
...
- [`design/ecosystem-case-study-odoo.md`](design/ecosystem-case-study-odoo.md) — **Learnability lesson (Odoo Community).** Partial positive — Community Edition tryability; Umbraculum copies the ladder, not the cert/partner gate.
...
- [`design/ecosystem-case-study-omnis.md`](design/ecosystem-case-study-omnis.md) — **Practitioner case study (Omnis Studio).** Good product, ecosystem never formed; why documentation, community, Git/text backbone, and free try are non-optional; rewrite caution (§6). Pairs with Adobe → Magento in [`MANIFESTO.md`](../MANIFESTO.md) §2.1 and *From practice, not theory* in [`PLATFORM-ARCHITECTURE.md`](PLATFORM-ARCHITECTURE.md) §2.1. Also indexed under **Vision & strategy** above.
...
- [`design/ecosystem-case-study-odoo.md`](design/ecosystem-case-study-odoo.md) — **Practitioner case study (Odoo Community).** Partial positive on learnability; deliberate skip of certification economy. Rewrite caution (§5).
