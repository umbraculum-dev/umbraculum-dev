...
- [`design/production-hosts.md`](design/production-hosts.md) — **Production VPS repos** (`umbraculum-hosting-common`, `-forum`, `-demo`), local clone layout, volunteer routing; forum governance stays in [`design/community-forum-runbook.md`](design/community-forum-runbook.md) §6–§7.
