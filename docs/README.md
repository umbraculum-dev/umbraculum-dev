...
- [`CORE-DEVELOPMENT-AND-COMMUNITY.md`](CORE-DEVELOPMENT-AND-COMMUNITY.md) — Community proposal mechanism and sponsorship principles, including the AI-compute capacity ask.
