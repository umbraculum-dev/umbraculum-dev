...
- [`design/ecosystem-case-study-adobe-magento.md`](design/ecosystem-case-study-adobe-magento.md) — **Stewardship lesson (Adobe → Magento).** ece-tools deploy integration vs agency-owned CI (§3.5); commercial trap; Mage-OS fork; always-green public-repo CI ([`MANIFESTO.md`](../MANIFESTO.md) §2.1).
