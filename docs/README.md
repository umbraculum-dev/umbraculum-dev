...
- [`design/ecosystem-case-study-omnis.md`](design/ecosystem-case-study-omnis.md) — **Ecosystem lesson (Omnis).** Good product; Core vs verticals governance, 2016 doc-site fragility (§3.5–§3.7); maps to community, open repos, and free-try commitments.
...
- [`design/ecosystem-case-study-omnis.md`](design/ecosystem-case-study-omnis.md) — **Practitioner case study (Omnis Studio).** Good product, ecosystem never formed; Core/vertical dynamics and long-run migration fear (§3.5–§3.7); rewrite caution (§6).
