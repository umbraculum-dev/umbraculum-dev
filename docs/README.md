...
- [`design/ecosystem-case-study-adobe-magento.md`](design/ecosystem-case-study-adobe-magento.md) — **Stewardship lesson (Adobe → Magento).** Community lost through governance and doc fragmentation; cloud CI / ece-tools vs third-party modules (§3.5); Mage-OS fork counter-case; maps to **always-green CI**, AGPL, doc redirects ([`MANIFESTO.md`](../MANIFESTO.md) §2.1).
...
- [`design/ecosystem-case-study-adobe-magento.md`](design/ecosystem-case-study-adobe-magento.md) — **Practitioner case study (Adobe → Magento).** Stewardship failure, doc 404s, certification churn, **cloud CI / third-party modules / ece-tools (§3.5)**, Mage-OS fork; pairs with Omnis doc fragility. Rewrite caution (§7).
