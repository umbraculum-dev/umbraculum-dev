...
- [`design/ecosystem-case-study-adobe-magento.md`](design/ecosystem-case-study-adobe-magento.md) — **Stewardship lesson (Adobe → Magento).** Community lost through governance and doc fragmentation; Mage-OS fork counter-case; maps to AGPL, no cert gate, doc redirects, livelihood sustainability ([`MANIFESTO.md`](../MANIFESTO.md) §2.1).
...
- [`design/ecosystem-case-study-adobe-magento.md`](design/ecosystem-case-study-adobe-magento.md) — **Practitioner case study (Adobe → Magento).** Stewardship failure, doc 404s, certification churn, Mage-OS fork; pairs with Omnis doc fragility. Rewrite caution (§7).
