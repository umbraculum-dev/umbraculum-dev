...
- [`rfcs/0006-amend-rfc-0002-brewery-file-move-acceleration.md`](rfcs/0006-amend-rfc-0002-brewery-file-move-acceleration.md) — Narrow amendment to RFC-0002 Decision D: pulls the brewery file-move tranche forward from H1 2027 into Week 1 of the late-H1-2026 tranche (2026-05-20 → 2026-05-26), bundled with the web-route-shape audit. URLs preserved end-to-end (β semantics); Prisma `public.*` brewery schema deferral retained (Accepted 2026-05-21).
