...
- [`design/ecosystem-case-study-adobe-magento.md`](design/ecosystem-case-study-adobe-magento.md) — **Stewardship lesson (Adobe → Magento).** Community lost through governance and doc fragmentation; cloud integration pipelines failing; Mage-OS fork counter-case; maps to AGPL, **CI by default**, no cert gate, doc redirects ([`MANIFESTO.md`](../MANIFESTO.md) §2.1).
...
- [`design/ecosystem-case-study-adobe-magento.md`](design/ecosystem-case-study-adobe-magento.md) — **Practitioner case study (Adobe → Magento).** Stewardship failure, doc 404s, certification churn, **cloud pipeline / integration abandonment (§3.5)**, Mage-OS fork; pairs with Omnis doc fragility. Rewrite caution (§7).
