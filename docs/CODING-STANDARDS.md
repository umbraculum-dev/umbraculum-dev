...
We treat `@brewery/contracts` (`/home/rf/dkprojects/rfapps/umbraculum-dev/packages/contracts/`) as the **single source of DTO truth** for endpoints that must stay stable across **web + native**.
