...
|---|---|---|
| [`@umbraculum/module-sdk`](../packages/sdk/module-sdk/README.md) | `@umbraculum/module-sdk` | The SDK every module pins. `registerModule()`, `registerAiTools`, `documentTemplates`, reserved-code validation, `ValidatedSchema<T>`. |
| [`@umbraculum/ai-tool-sdk`](../packages/sdk/ai-tool-sdk/README.md) | `@umbraculum/ai-tool-sdk` | Public AI-tool contract (`AiTool`, `AiToolRegistry`, `AiToolScope`, `AiToolContext`) consumed by module-owned tool bundles. Extracted from `@umbraculum/contracts` on 2026-05-21. |
...
| [`@umbraculum/automation-contracts`](../packages/canonical/automation/contracts/README.md) | (already renamed — slot 4 done) | Contracts slice of the `automation` canonical module. The Modbus mailbox mirror lives here. |
...
| Contracts | [`packages/canonical/automation/contracts/`](../packages/canonical/automation/contracts/) → [`@umbraculum/automation-contracts`](../packages/canonical/automation/contracts/README.md) | Adapter SDK types (`AutomationAdapterDefinition`), `VesselStateSchema`, `CONTRACT_VERSION`, the typed Modbus mailbox mirror. The only piece a third-party adapter pins. |
...
The full SDK options surface (route registrars, `tierLimits`, `registerAiTools`, `documentTemplates`) is documented in [`packages/sdk/module-sdk/src/types.ts`](../packages/sdk/module-sdk/src/types.ts) and [`packages/sdk/module-sdk/README.md`](../packages/sdk/module-sdk/README.md).

### 5.3 The contracts package — what third parties pin

[`packages/canonical/automation/contracts/`](../packages/canonical/automation/contracts/) is the only piece of `automation` a third-party adapter author depends on. It exports four surfaces ([`@umbraculum/automation-contracts` README](../packages/canonical/automation/contracts/README.md)):
