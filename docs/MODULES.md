...
| `mrp` | Wave 3 read-only alpha experience shipped — contracts + read-only API plus web-visible brewery BOM/order/requirement projections; August 2026 alpha proof still in progress; mature scope still H1 2027 | Material requirements planning, production orders, work orders | AGPLv3 | [modules/canonical/mrp.md](modules/canonical/mrp.md) |
...
| `crp` | Wave 3 read-only alpha experience shipped — contracts + read-only API plus web-visible vessel/resource/schedule projections; August 2026 alpha proof still in progress; mature scope still H1 2027 (paired with `mrp`) | Capacity requirements planning, resource scheduling, work-center load | AGPLv3 | [modules/canonical/crp.md](modules/canonical/crp.md) |
...
Note on "open door": the code is reserved and the folder shape is pre-committed by [RFC-0002](rfcs/0002-canonical-module-physical-layout.md). The work to design and ship each module's surface is its own future RFC or design artifact ([RFC-0001](rfcs/0001-modules-tiers-governance-and-automation-placement.md) §12.4). For `mrp` and `crp`, Wave 1 foundation artifacts now exist (`@umbraculum/mrp-contracts`, `@umbraculum/crp-contracts`, and read-only API skeletons), Wave 2 proves read-time brewery projections through those canonical surfaces, and Wave 3 makes the projections visible in read-only web pages. This is still not the full public-alpha proof. The August 2026 alpha planning/build artifacts remain [`design/mrp-crp-august-2026-co-design-plan.md`](design/mrp-crp-august-2026-co-design-plan.md), [`design/canonical-mrp-module-surface.md`](design/canonical-mrp-module-surface.md), [`design/canonical-crp-module-surface.md`](design/canonical-crp-module-surface.md), [`design/mrp-crp-wave-1-build-log.md`](design/mrp-crp-wave-1-build-log.md), [`design/mrp-crp-wave-2-brewery-projection-build-log.md`](design/mrp-crp-wave-2-brewery-projection-build-log.md), and [`design/mrp-crp-wave-3-read-only-alpha-experience-build-log.md`](design/mrp-crp-wave-3-read-only-alpha-experience-build-log.md).
