...
|---|---|---|
| [`@umbraculum/module-sdk`](../packages/modules/module-sdk/README.md) | `@umbraculum/module-sdk` | The SDK every module pins. `registerModule()`, `registerAiTools`, `documentTemplates`, reserved-code validation, `ValidatedSchema<T>`. |
| [`@umbraculum/ai-tool-sdk`](../packages/modules/ai-tool-sdk/README.md) | `@umbraculum/ai-tool-sdk` | Public AI-tool contract (`AiTool`, `AiToolRegistry`, `AiToolScope`, `AiToolContext`) consumed by module-owned tool bundles. Extracted from `@umbraculum/contracts` on 2026-05-21. |
| [`@umbraculum/contracts`](../packages/platform/contracts/README.md) | `@umbraculum/contracts` (sub-plan #9 slot 9) | Platform-wide auth/me DTOs and shared API wire contracts. |
| [`@umbraculum/automation-contracts`](../packages/modules/automation-contracts/README.md) | (already renamed — slot 4 done) | Contracts slice of the `automation` canonical module. The Modbus mailbox mirror lives here. |
| [`@umbraculum/api-client`](../packages/platform/api-client/README.md) | (renamed — slot 10 done) | Fetch + auth boundary (cookie web, bearer native). |
| [`@umbraculum/i18n`](../packages/platform/i18n/README.md) | (renamed — slot 7 done) | Cross-platform message catalog (web + native). |
| [`@umbraculum/i18n-react`](../packages/platform/i18n-react/README.md) | (renamed — slot 8 done) | Universal `useT` hook for React + React Native. |
| [`@umbraculum/ui`](../packages/platform/ui/README.md) | (renamed — slot 5 done) | Tamagui primitives + design-system components. Industry-agnostic. |
| [`@umbraculum/navigation`](../packages/platform/navigation/README.md) | (renamed — slot 3 done) | Route IDs + cross-platform routing policy. |
| [`@umbraculum/media`](../packages/platform/media/README.md) | (renamed — slot 2 done) | Shared assets framework. |
| [`@umbraculum/test-mcp`](../packages/platform/test-mcp/README.md) | (renamed — slot 1 done) | Test-MCP HTTP server exposing testing tools. Developer tooling. |
| [`@umbraculum/rendering`](../packages/platform/rendering/README.md) | `@umbraculum/rendering` | Centralized document / file rendering pipeline (Gotenberg sidecar for HTML→PDF + DOCX/ODT→PDF; exceljs / fast-csv / bwip-js / xmlbuilder2 / eta / MJML in-process; async-via-BullMQ on existing Redis). Allocated by [RFC-0007](rfcs/0007-canonical-document-rendering.md); RFC-0007 PR1-PR7 have landed the package scaffold, engine adapters, job-runner wiring, sync BeerJSON proof, platform `render_document` AI tool, and the first async PIM channel-feed consumer. Industry-agnostic; unprefixed scope per [RFC-0002](rfcs/0002-canonical-module-physical-layout.md) §4. |
| `@umbraculum/brewery-core` ([`packages/verticals/brewery/core/`](../packages/verticals/brewery/core/)) | (renamed — slot 6 done; vertical-prefixed) | Brewery-vertical brewing math (gravity, water). **Vertical-prefixed scope** — see RFC-0002 §4. README: [`packages/verticals/brewery/core/README.md`](../packages/verticals/brewery/core/README.md). |
| [`@umbraculum/brewery-beerjson`](../packages/verticals/brewery/beerjson/README.md) | (renamed — slot 12 done; vertical-prefixed) | Brewery-vertical BeerJSON spec layer. |
| [`@umbraculum/brewery-recipes-ui`](../packages/verticals/brewery/recipes-ui/README.md) | (renamed — slot 13 done; vertical-prefixed) | Brewery-vertical recipe/water/yeast UI. |
...
| Contracts | [`packages/modules/automation-contracts/`](../packages/modules/automation-contracts/) → [`@umbraculum/automation-contracts`](../packages/modules/automation-contracts/README.md) | Adapter SDK types (`AutomationAdapterDefinition`), `VesselStateSchema`, `CONTRACT_VERSION`, the typed Modbus mailbox mirror. The only piece a third-party adapter pins. |
...
The full SDK options surface (route registrars, `tierLimits`, `registerAiTools`, `documentTemplates`) is documented in [`packages/modules/module-sdk/src/types.ts`](../packages/modules/module-sdk/src/types.ts) and [`packages/modules/module-sdk/README.md`](../packages/modules/module-sdk/README.md).

### 5.3 The contracts package — what third parties pin

[`packages/modules/automation-contracts/`](../packages/modules/automation-contracts/) is the only piece of `automation` a third-party adapter author depends on. It exports four surfaces ([`@umbraculum/automation-contracts` README](../packages/modules/automation-contracts/README.md)):
