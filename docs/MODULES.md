...
| `mrp` | Wave 1 foundation shipped — contracts + read-only API skeleton; August 2026 alpha proof still in progress; mature scope still H1 2027 | Material requirements planning, production orders, work orders | AGPLv3 | [modules/canonical/mrp.md](modules/canonical/mrp.md) |
...
| `crp` | Wave 1 foundation shipped — contracts + read-only API skeleton; August 2026 alpha proof still in progress; mature scope still H1 2027 (paired with `mrp`) | Capacity requirements planning, resource scheduling, work-center load | AGPLv3 | [modules/canonical/crp.md](modules/canonical/crp.md) |
