...
| `mrp` | Wave 5 AI advisor + Wave 6 rendering + alpha demo export UI (browser async exports on production-order pages; runbook [`design/mrp-crp-alpha-demo-walkthrough.md`](design/mrp-crp-alpha-demo-walkthrough.md)) — read-only API + fixture-backed brewery projections; alpha proof not complete; mature scope H1 2027 | Material requirements planning, production orders, work orders | AGPLv3 | [modules/canonical/mrp.md](modules/canonical/mrp.md) |
...
| `crp` | Wave 5 AI advisor + Wave 6 rendering + alpha demo export UI (capacity/schedule/resources exports; same runbook) — read-only API + fixture-backed projections; alpha proof not complete; mature scope H1 2027 (paired with `mrp`) | Capacity requirements planning, resource scheduling, work-center load | AGPLv3 | [modules/canonical/crp.md](modules/canonical/crp.md) |
