...
| `mrp` | Wave 5 read-only AI planning advisor shipped — contracts + read-only API plus web-visible, fixture-backed, and AI-readable brewery BOM/order/requirement projections; August 2026 alpha proof still in progress; mature scope still H1 2027 | Material requirements planning, production orders, work orders | AGPLv3 | [modules/canonical/mrp.md](modules/canonical/mrp.md) |
...
Note on "open door": the code is reserved and the folder shape is pre-committed by [RFC-0002](rfcs/0002-canonical-module-physical-layout.md). The work to design and ship each module's surface is its own future RFC or design artifact ([RFC-0001](rfcs/0001-modules-tiers-governance-and-automation-placement.md) §12.4). For `mrp` and `crp`, Wave 1 foundation artifacts now exist (`@umbraculum/mrp-contracts`, `@umbraculum/crp-contracts`, and read-only API skeletons), Wave 2 proves read-time brewery projections through those canonical surfaces, Wave 3 makes the projections visible in read-only web pages, Wave 4 makes that read-only proof deterministic through fixture-backed E2E coverage, and Wave 5 adds read-only AI planning advisor tools over the same services. This is still not the full public-alpha proof. The August 2026 alpha planning/build artifacts remain [`design/mrp-crp-august-2026-co-design-plan.md`](design/mrp-crp-august-2026-co-design-plan.md), [`design/canonical-mrp-module-surface.md`](design/canonical-mrp-module-surface.md), [`design/canonical-crp-module-surface.md`](design/canonical-crp-module-surface.md), [`design/mrp-crp-wave-1-build-log.md`](design/mrp-crp-wave-1-build-log.md), [`design/mrp-crp-wave-2-brewery-projection-build-log.md`](design/mrp-crp-wave-2-brewery-projection-build-log.md), [`design/mrp-crp-wave-3-read-only-alpha-experience-build-log.md`](design/mrp-crp-wave-3-read-only-alpha-experience-build-log.md), [`design/mrp-crp-wave-4-alpha-proof-hardening-build-log.md`](design/mrp-crp-wave-4-alpha-proof-hardening-build-log.md), and [`design/mrp-crp-wave-5-ai-planning-advisor-build-log.md`](design/mrp-crp-wave-5-ai-planning-advisor-build-log.md).
