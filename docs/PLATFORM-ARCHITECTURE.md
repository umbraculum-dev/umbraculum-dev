...
- **DONE (scaffold):** tier limits are module-aware — platform `aiEnabled` + `composeModuleTierLimitSlices()` at boot; see [`packages/modules/module-sdk/README.md`](../packages/modules/module-sdk/README.md) §"Tier-limit registration".
...
- `@umbraculum/module-sdk` — the `registerModule()` contract, types, and helper utilities. **Physical package** at [`packages/modules/module-sdk/`](../packages/modules/module-sdk/).
- `@umbraculum/ai-tool-sdk` — the `AiTool<I, O>` interface, scope types, and `AiToolContext` definitions. **Physical package** at [`packages/modules/ai-tool-sdk/`](../packages/modules/ai-tool-sdk/) since 2026-05-21 (extracted from `@umbraculum/contracts` per the deferred-extraction note in [`packages/modules/ai-tool-sdk/src/aiTool.ts`](../packages/modules/ai-tool-sdk/src/aiTool.ts) header).
