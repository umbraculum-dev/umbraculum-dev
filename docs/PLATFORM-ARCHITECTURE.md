...
- **Current state (2026-06-27 — post-flip).** The monorepo at **`github.com/umbraculum-dev/umbraculum-dev`** and sister repos **`umbraculum-toolset`** and **`umbraculum-brochure`** are **public**. **Stage 2 atomic flip ✅ 2026-06-27** — GitHub Release [`v0.0.1-alpha`](https://github.com/umbraculum-dev/umbraculum-dev/releases/tag/v0.0.1-alpha); brochure/docs **`noindex` removed**; Algolia DocSearch live on [docs.umbraculum.dev](https://docs.umbraculum.dev/). **Production surfaces:** [umbraculum.dev](https://umbraculum.dev/), [docs.umbraculum.dev](https://docs.umbraculum.dev/), [forum.umbraculum.dev](https://forum.umbraculum.dev/) (2026-06-08), [demo.umbraculum.dev](https://demo.umbraculum.dev/) (2026-06-03), [umbraculum.dev/support/](https://umbraculum.dev/support/) (**2d ✅ 2026-06-26**). **MIT npm SDK publish batch ✅ 2026-05-29.** **Remaining post-flip tail:** Cursor marketplace listings live (**C6** — submission ✅ 2026-06-27); see [`public-alpha-flip-day-runbook.md`](design/public-alpha-flip-day-runbook.md) §11.
- **Decision.** **July 2026 public alpha executed 2026-06-27** — ahead of the original H1 2027 public-flip horizon. Forum, demo, and donation URLs were already live pre-flip; the atomic moment was GitHub visibility + SEO gates + launch comms.
...
- **Pre-flip checklist** (kept here so the conditions are explicit, not folkloric):
  ...
  5. A short public-launch blog post / `docs/`-hosted announcement explaining the project, the licensing posture, and how to contribute — **✅ published 2026-06-27** ([`PUBLIC-ALPHA-ANNOUNCEMENT.md`](PUBLIC-ALPHA-ANNOUNCEMENT.md); GitHub Release [`v0.0.1-alpha`](https://github.com/umbraculum-dev/umbraculum-dev/releases/tag/v0.0.1-alpha); forum [topic/84](https://forum.umbraculum.dev/t/umbraculum-public-alpha-open-source-toolset-for-workspace-shaped-operational-applications/84)).
...
- **Marketplace-submission and public-alpha closure criterion.** The **three** umbraculum-toolset Cursor plugins required for umbraculum-dev contributors were **submitted to the Cursor marketplace 2026-06-27** (**C2 ✅**). All **three source repos** are **public** since the same session. The public-alpha procedure is **COMPLETE only when the three marketplace listings are live** (**C6** — Cursor-side approval; days to weeks). Until listings publish, the hook + source install path in [`CURSOR-PLUGINS.md`](CURSOR-PLUGINS.md) remains canonical ([`AGENTS.md`](../AGENTS.md) apparatus self-check). Once listings go live, steady-state install flips to **marketplace per-workspace enablement** — see flip runbook §11 and [`ROADMAP.md`](ROADMAP.md).
