...
Boot-time registry MUST reject duplicate `addonCodes` across modules ([`packages/sdk/module-sdk`](../../packages/sdk/module-sdk/) — shipped with this RFC).
