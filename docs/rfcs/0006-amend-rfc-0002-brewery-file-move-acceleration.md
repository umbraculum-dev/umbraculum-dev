...
- **Cross-ref amendment**: [`packages/module-sdk/README.md`](../../packages/module-sdk/README.md) — document the extended `registerWebModule({ ownedUrlSegments, navEntry })` surface and remove the stale "H1 2027 migration" reference in the inline docstring of `packages/module-sdk/src/registerWebModule.ts`.
