...
- **Cross-ref amendment**: [`packages/modules/module-sdk/README.md`](../../packages/modules/module-sdk/README.md) — document the extended `registerWebModule({ ownedUrlSegments, navEntry })` surface and remove the stale "H1 2027 migration" reference in the inline docstring of `packages/modules/module-sdk/src/registerWebModule.ts`.
