...
**Touched docs:** [`docs/rfcs/README.md`](README.md), [`docs/rfcs/0002-canonical-module-physical-layout.md`](0002-canonical-module-physical-layout.md) §3–§4, §11, §12, [`docs/ROADMAP.md`](../ROADMAP.md) (Week 1 tail), [`docs/design/platform-brewery-postgres-schema-split.md`](../design/platform-brewery-postgres-schema-split.md), [`docs/design/public-alpha-preflip-hygiene-checklist.md`](../design/public-alpha-preflip-hygiene-checklist.md) §3.5, [`docs/design/rfc-companion-documentation-audit.md`](../design/rfc-companion-documentation-audit.md).
