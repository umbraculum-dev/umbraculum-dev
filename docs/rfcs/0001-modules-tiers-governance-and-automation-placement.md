...
| i18n | `@umbraculum/i18n` + `useT` hook ([`packages/platform/i18n/`](../../packages/platform/i18n/), [`packages/platform/i18n-react/`](../../packages/platform/i18n-react/)) | Use platform i18n; module strings live under module-prefixed namespace per [`docs/PLATFORM-ARCHITECTURE.md`](../PLATFORM-ARCHITECTURE.md) §4.4 | Module-namespaced translation files |
| UI primitives | Tamagui tokens, design system, accessibility primitives, route IDs ([`packages/platform/ui/`](../../packages/platform/ui/), [`packages/platform/navigation/`](../../packages/platform/navigation/)) | Use platform UI primitives; module screens consume the design system | Module-defined components built on top of `@umbraculum/ui` |
