...
| [0012](0012-package-tier-clarity.md) | Package tier clarity | Accepted | 2026-06-08 | Replaces `packages/modules/` with four peer tiers: `platform/`, `sdk/`, `canonical/<code>/contracts/`, `verticals/<code>/*`. MIT batch npm **0.2.0** (tier-move). Companion: [`NAVIGATE-MONOREPO.md`](../NAVIGATE-MONOREPO.md). |
