...
- The module SDK's public surface ([`../../packages/sdk/module-sdk/README.md`](../../packages/sdk/module-sdk/README.md)).
...
| [0002](0002-canonical-module-physical-layout.md) | Canonical-module physical layout | Accepted | 2026-05-19 | β layout (three runtime trees + contracts per module): `services/api/src/modules/<code>/`, `apps/web/app/[locale]/(<code>)/`, `apps/native/src/modules/<code>/`, `packages/canonical/<code>/contracts/` (amended by RFC-0012). `registerModule()` in `packages/sdk/module-sdk/`. |
...
| [0012](0012-package-tier-clarity.md) | Package tier clarity | Accepted | 2026-06-08 | Replaces `packages/modules/` with four peer tiers: `platform/`, `sdk/`, `canonical/<code>/contracts/`, `verticals/<code>/*`. MIT batch semver reset to 0.1.0. Companion: [`NAVIGATE-MONOREPO.md`](../NAVIGATE-MONOREPO.md). |
