...
| **Core installation profile** | Default fresh clone — canonical modules only; native app `starter`; no `brewery.*` in DB after migrate. | `UMBRACULUM_MODULE_PROFILE=platform` | [`install.core.json`](../.umbraculum/install.core.json) |
