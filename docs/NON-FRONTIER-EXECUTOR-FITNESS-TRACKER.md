...
1. **Enumerate every gate skill to run, by name, at each phase
   ...
   `packages/modules/pim-contracts/README.md` and on `services/api/src/modules/pim/README.md`;
   run `typescript-strict-flag-verification` on `packages/modules/pim-contracts/`;
