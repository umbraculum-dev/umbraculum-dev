...
- the generic agentic-browser skill (above) — gives you the protocol/bounds/output contract,
- the test-MCP skill [`.cursor/skills/test-mcp-server.md`](../.cursor/skills/test-mcp-server.md) — gives you the non-UI prerequisites (`smokeStack`, `seedE2eFixture`, `loginAs`),
