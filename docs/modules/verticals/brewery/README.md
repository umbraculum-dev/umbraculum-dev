...
| `mrp` | **Wave 5 read-only AI advisor + Wave 6 rendering templates shipped** (August 2026 alpha co-design target still in progress; mature scope H1 2027) | Brew sessions project as production orders, recipes as BOMs, session steps as operations, and recipe ingredients as assumption-only material requirements through canonical MRP read routes, web pages, AI advisor tools, and RFC-0007 work-order/material-requirement exports. Read-time projection only: brewery remains source of truth; no MRP write workflow is implied. |
| `wms` | Open door (H2 2027) | Brewery ingredients become catalog SKUs; the on-hand inventory becomes WMS stock-on-hand. |
| `crp` | **Wave 5 read-only AI advisor + Wave 6 rendering templates shipped** (August 2026 alpha co-design target still in progress; mature scope H1 2027) | Automation vessels project as CRP resources, equipment profiles as work centers, and timed brew-session steps as scheduled operations/load/conflicts through canonical CRP read routes, web pages, AI advisor tools, and RFC-0007 capacity/schedule exports. Read-time projection only: brewery/automation remain source of truth; no CRP write workflow or optimizer is implied. |
