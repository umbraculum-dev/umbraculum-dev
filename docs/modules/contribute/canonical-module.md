...
You want to add a new code to `RESERVED_CANONICAL_MODULE_CODES` ([`packages/module-sdk/src/reservedCodes.ts`](../../../packages/module-sdk/src/reservedCodes.ts)). Examples [RFC-0001 §4.2](../../rfcs/0001-modules-tiers-governance-and-automation-placement.md) names as plausible-but-not-allocated:
...
- [`packages/module-sdk/src/reservedCodes.ts`](../../../packages/module-sdk/src/reservedCodes.ts) — where new codes land.
