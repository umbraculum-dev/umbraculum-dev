...
| Contracts | [`packages/canonical/pim/contracts/`](../../../packages/canonical/pim/contracts/) → `@umbraculum/pim-contracts` | Shipped — `CONTRACT_VERSION 0.1.0-alpha.1`, 6 schema families, 7/7 tests green, dist artifacts emitted |
...
| Phase A — contracts | **Shipped** | [`packages/canonical/pim/contracts/`](../../../packages/canonical/pim/contracts/). 6 Zod schema families, `CONTRACT_VERSION 0.1.0-alpha.1`, 7/7 tests green. |
