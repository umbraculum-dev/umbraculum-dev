# Open-source stack — per-dependency rationale
...
This document is the **per-dependency analytical companion** to
...
- **Role.** The PLC IDE + runtime the brewery vertical's
  ...
  sister repo (see [`modules/verticals/brewery.md §3.7`](modules/verticals/brewery.md))
...
- **Role.** The canonical interchange format for brewery recipes
  ...
  styles). See [`BEERJSON-FIRST.md`](BEERJSON-FIRST.md).
...
- Per-domain docs cross-linked inline above
  ...
  [`BEERJSON-FIRST.md`](BEERJSON-FIRST.md), etc.).
