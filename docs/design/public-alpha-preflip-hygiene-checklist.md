...
| **C5** | **Algolia DocSearch** application | [`docsearch-application-draft.md`](docsearch-application-draft.md) · [apply](https://docsearch.algolia.com/apply) · account [`maintainer-external-service-accounts.md`](maintainer-external-service-accounts.md) | **immediately after** `noindex` removal (2c §3) | ☐ **Next maintainer action** — GitHub OAuth same as C2 |
