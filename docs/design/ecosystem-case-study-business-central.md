...
| Version skew silent at runtime | **Explicit `CONTRACT_VERSION` handshake** where adapters apply | [`packages/canonical/automation/contracts`](../../packages/canonical/automation/contracts/README.md); [`canonical-automation-module-surface.md`](canonical-automation-module-surface.md) §12 |
