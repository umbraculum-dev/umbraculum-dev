...
|---|---|---|
| Contracts | [`packages/canonical/pim/contracts/`](../../packages/canonical/pim/contracts/) | `CONTRACT_VERSION 0.1.0-alpha.1`, 6 entity-family Zod schemas (Product, Variant, AttributeSet, Attribute, Category, MediaAssetRef), create/update request schemas, response envelopes, delete envelope |
...
[`packages/canonical/pim/contracts/`](../../packages/canonical/pim/contracts/) — Zod-only contracts package, MIT-licensed, ESM+CJS dual emit per [RFC-0002](../rfcs/0002-canonical-module-physical-layout.md) Decision C.
...
Vendor-specific storefront / marketplace projections are still out of scope. When they land, they belong in either a sibling commerce canonical (preferred) or a `pim-feeds/` submodule — **not** inside `packages/canonical/pim/contracts/` (which must stay vendor-agnostic).
...
- [`packages/canonical/pim/contracts/`](../../packages/canonical/pim/contracts/) — Phase A contracts.
