...
It does **not** override product UI in `apps/web/` (operational app chrome follows platform UX patterns). It **does** align with docs-site tone — Docusaurus theme choices should stay similarly restrained; see RFC-0005 and the docs build log for docs-specific decisions.
