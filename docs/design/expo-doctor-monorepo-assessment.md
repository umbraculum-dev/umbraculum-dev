...
| 2026-06 | **Installation profile:** core → `blank` (was `starter`), reference → `brewery`; see [`installation-profile.md`](installation-profile.md) |
