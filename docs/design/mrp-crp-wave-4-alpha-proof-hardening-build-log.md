...
| Phase D — E2E proof | Completed | `apps/web/e2e/canonical/mrp-crp-read-only-alpha.spec.ts` *(RFC-0011 Wave 5 path)* | Pending Phase F gates | The smoke now asserts fixture-backed content across MRP materials and CRP resource/capacity/schedule/conflict surfaces. |
