...
| SDK | [`packages/module-sdk/src/types.ts`](../../packages/module-sdk/src/types.ts), [`moduleRegistry.ts`](../../packages/module-sdk/src/moduleRegistry.ts) |
...
| Chat contract | [`packages/contracts/src/ai/aiChat.ts`](../../packages/contracts/src/ai/aiChat.ts) |
...
| UI hook | [`packages/ui/src/ai/useAiChatStream.ts`](../../packages/ui/src/ai/useAiChatStream.ts) |
...
```bash
# module-sdk (host)
cd packages/module-sdk && npm test && npm run build
