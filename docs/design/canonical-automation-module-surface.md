...
**Builds on:** [RFC-0001](../rfcs/0001-modules-tiers-governance-and-automation-placement.md), [RFC-0002](../rfcs/0002-canonical-module-physical-layout.md), [`docs/PLATFORM-ARCHITECTURE.md`](../PLATFORM-ARCHITECTURE.md) §4.4, §6, [`packages/modules/module-sdk/README.md`](../../packages/modules/module-sdk/README.md)
...
β layout per [RFC-0002](../rfcs/0002-canonical-module-physical-layout.md): `services/api/src/modules/automation/`, `apps/web/app/[locale]/(automation)/`, `apps/native/src/modules/automation/`, `packages/modules/automation-contracts/`. Postgres schema `automation` when tables land (§8).
...
- New `packages/modules/automation-contracts/` — mailbox types, adapter SDK types, `CONTRACT_VERSION` constant. No runtime code.
...
| # | Step | Repo | Status |
|---|---|---|---|
| 1 | Scaffold `packages/modules/automation-contracts/` (types-only, vitest, tsup) | `umbraculum-dev` | **Done** — see commit log |
