...
**Builds on:** [`canonical-document-rendering-engine-rationale.md`](canonical-document-rendering-engine-rationale.md), [`packages/platform/rendering/README.md`](../../packages/platform/rendering/README.md), [`packages/sdk/module-sdk/README.md`](../../packages/sdk/module-sdk/README.md)
...
| Template registration | `registerModule({ documentTemplates })` | [`packages/sdk/module-sdk/src/moduleRegistry.ts`](../../packages/sdk/module-sdk/src/moduleRegistry.ts) |
