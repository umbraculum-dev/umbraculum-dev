...
| Package | Tier | Role |
|---|---|---|
| [`@umbraculum/module-sdk`](../../packages/sdk/module-sdk/README.md) | 2 (MIT) | `registerModule()`, `registerWebModule()`, `registerNativeModule()`, reserved codes, `ValidatedSchema<T>`, document-template types |
| [`@umbraculum/ai-tool-sdk`](../../packages/sdk/ai-tool-sdk/README.md) | 2 (MIT) | AI tool contract types |
| [`@umbraculum/i18n-keys`](../../packages/sdk/i18n-keys/README.md) | 2 (MIT) | Module nav / message-key conventions |
...
- [packages/sdk/module-sdk/README.md](../../packages/sdk/module-sdk/README.md) — registration contract (the backbone SDK)
