...
| `apps/web/app/recipes/_components/yeastEditor/YeastEditorEditable.tsx` | 1108 | Apps (web) | S, I | P1 | file size 1108 LoC | Split by reason-to-change; see Tier B in solid-decoupling-audit.md |
