...
| `apps/web/app/recipes/[id]/water/mash/_lib/waterMashAcidificationHelpers.ts` | 750 | Apps (web) | D | P2 | review client-safe import "@umbraculum/brewery-recipes-ui" | Confirm package is client-safe per DATA-ACCESS-BOUNDARIES.md |
...
| `apps/web/app/recipes/[id]/water/mash/_lib/waterMashAcidificationHelpers.ts` | 750 | Apps (web) | S, I | P3 | file size 750 LoC | Review logical cohesion |
