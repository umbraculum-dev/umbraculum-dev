...
| `apps/web/app/recipes/[id]/edit/_hooks/useRecipeEditPage.ts` | 1332 | Apps (web) | S, I | P1 | file size 1332 LoC | Split by reason-to-change; see Tier B in solid-decoupling-audit.md |
| `apps/native/src/modules/brewery/components/recipeEdit/RecipeEditScreenContent.tsx` | 1329 | Apps (native) | S, I | P1 | file size 1329 LoC | Split by reason-to-change; see Tier B in solid-decoupling-audit.md |
...
| `apps/native/src/modules/brewery/hooks/useRecipeEditScreen.ts` | 814 | Apps (native) | S, I | P1 | file size 814 LoC | Split by reason-to-change; see Tier B in solid-decoupling-audit.md |
...
| `apps/web/app/recipes/[id]/edit/_hooks/useRecipeEditPage.ts` | 1332 | Apps (web) | D | P2 | review client-safe import "@umbraculum/brewery-recipes-ui" | Confirm package is client-safe per DATA-ACCESS-BOUNDARIES.md |
| `apps/native/src/modules/brewery/components/recipeEdit/RecipeEditScreenContent.tsx` | 1329 | Apps (native) | D | P2 | review client-safe import "@umbraculum/brewery-beerjson" | Confirm package is client-safe per DATA-ACCESS-BOUNDARIES.md |
...
| `apps/native/src/modules/brewery/hooks/useRecipeEditScreen.ts` | 814 | Apps (native) | D | P2 | review client-safe import "@umbraculum/brewery-beerjson" | Confirm package is client-safe per DATA-ACCESS-BOUNDARIES.md |
...
| `services/api/src/modules/brewery/routes/brewSessions.ts` | 494 | Brewery vertical | S, D | P2 | route file 494 LoC | Extract service layer; handler = parse → service → schema |
...
| `services/api/src/modules/brewery/routes/brewSessions.ts` | 494 | Brewery vertical | S, I | P3 | file size 494 LoC | Review logical cohesion |
