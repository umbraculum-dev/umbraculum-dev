...
| `apps/web/app/recipes/[id]/yeast/_hooks/useYeastPage.ts` | 531 | Apps (web) | D | P2 | review client-safe import "@umbraculum/brewery-recipes-ui" | Confirm package is client-safe per DATA-ACCESS-BOUNDARIES.md |
...
| `apps/web/app/recipes/[id]/yeast/_hooks/useYeastPage.ts` | 531 | Apps (web) | S, I | P3 | file size 531 LoC | Review logical cohesion |
