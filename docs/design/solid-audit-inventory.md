...
| `apps/web/app/recipes/[id]/water/_lib/waterCalcTypes.ts` | 55 | Apps (web) | D | P2 | review client-safe import "@umbraculum/brewery-recipes-ui" | Confirm package is client-safe per DATA-ACCESS-BOUNDARIES.md |
