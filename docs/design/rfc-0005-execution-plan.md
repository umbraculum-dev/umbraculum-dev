...
3. **Visual smoke check.** Navigate to: Reference → packages/platform/ui → packages/canonical/automation/contracts → services/api. Confirm rendering + cross-link resolution.
