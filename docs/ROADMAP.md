...
| **2c** | **Stage 2 atomic flip** — **three source repos** public (`umbraculum-dev`, `umbraculum-toolset`, `umbraculum-brochure`), `v0.0.1-alpha`, toolset marketplace submit, **Cloudflare deploy** (remove `noindex`) | **✅ 2026-06-27** — repos public; tag + SEO gates; marketplace + GitHub Release + comms remain | [`public-alpha-flip-day-runbook.md`](design/public-alpha-flip-day-runbook.md), [`public-alpha-cloudflare-pages-runbook.md`](design/public-alpha-cloudflare-pages-runbook.md) |
