...
**Public-alpha support and orientation pages.** ✅ **Phase 2 `2d` done (2026-06-26).** [https://umbraculum.dev/support/](https://umbraculum.dev/support/) is live with **Liberapay** (recurring) and **Buy Me a Coffee** (one-time); in-kind via forum per [`donation-channels.md`](design/donation-channels.md). Page stays **`noindex` until Stage 2 `2c`** (remove pre-flip SEO gates at flip) — expected. Principles: [`CORE-DEVELOPMENT-AND-COMMUNITY.md`](CORE-DEVELOPMENT-AND-COMMUNITY.md) §5. Further channels (GitHub Sponsors, Open Collective) require a community vote when runbook triggers fire.

**Public-alpha production hosts (live pre-flip).** ✅ **[forum.umbraculum.dev](https://forum.umbraculum.dev/)** — Discourse on Contabo VPS; §7.5 governance pins complete (2026-06-08). ✅ **[demo.umbraculum.dev](https://demo.umbraculum.dev/)** — brewery reference demo stack (2026-06-03). See [`design/production-hosts.md`](design/production-hosts.md), [`community-forum-runbook.md`](design/community-forum-runbook.md), [`demo-host-runbook.md`](design/demo-host-runbook.md). Flip **2c** still required for GitHub visibility, brochure/docs `noindex` removal, and marketplace submission — not for bringing these hosts online.
