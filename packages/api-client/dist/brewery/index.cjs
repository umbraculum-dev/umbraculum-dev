...
async function createRecipe(client, body) {
  const parsedBody = import_contracts.RecipeCreateRequestSchema.parse(body);
  return postParsed(
    client,
...
async function deleteRecipe(client, recipeId) {
  return deleteParsed(
    client,
    toClientPath(`/recipes/${encodeURIComponent(recipeId)}`),
    (data) => import_contracts.OkResponseSchema.parse(data)
  );
}
async function listRecipeVersions(client, recipeId) {
  return getParsed(
    ...
    (data) => import_contracts.RecipeVersionsResponseSchema.parse(data)
  );
}
...
function parseBeerJsonExportBody(data) {
  ...
  return import_contracts2.BeerJsonExportResponseSchema.parse(data);
}
...
async function listIngredientSyncRuns(client) {
  return getParsed(
    ...
    (data) => import_contracts3.IngredientSyncRunsResponseSchema.parse(data)
  );
}
async function runIngredientSync(client) {
  return postParsed(
    ...
    {},
    (data) => import_contracts3.IngredientSyncResponseSchema.parse(data)
  );
}
...
async function listStyles(client) {
  return getParsed(client, toClientPath("/styles"), (data) => import_contracts4.StylesListResponseSchema.parse(data));
}
...
function ingredientsQueryString(params) {
  if (!params) return "";
  const parsed = import_contracts5.IngredientsSearchQuerySchema.parse(params);
...
async function searchFermentables(client, params) {
  return getParsed(
    ...
    (data) => import_contracts5.FermentablesListResponseSchema.parse(data)
  );
}
async function searchHops(client, params) {
  return getParsed(
    ...
    (data) => import_contracts5.HopsListResponseSchema.parse(data)
  );
}
async function searchYeasts(client, params) {
  return getParsed(
    ...
    (data) => import_contracts5.YeastsListResponseSchema.parse(data)
  );
}
...
async function previewRecipeImport(client, body) {
  const parsedBody = import_contracts6.RecipeImportRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/recipes/import/preview"),
    parsedBody,
    (data) => import_contracts6.RecipeImportPreviewResponseSchema.parse(data)
  );
}
async function importRecipe(client, body) {
  ...
  return postParsed(
    ...
    parsedBody,
    (data) => import_contracts6.RecipeImportResponseSchema.parse(data)
  );
}
async function previewBulkRecipeImport(client, body) {
  const parsedBody = import_contracts6.RecipeBulkImportRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/recipes/import/bulk/preview"),
    parsedBody,
    (data) => import_contracts6.RecipeBulkImportPreviewResponseSchema.parse(data)
  );
}
async function importRecipesBulk(client, body) {
  ...
  return postParsed(
    ...
    parsedBody,
    (data) => import_contracts6.RecipeBulkImportResponseSchema.parse(data)
  );
}
...
async function getBrewSession(client, brewSessionId) {
  return getParsed(
    ...
    (data) => import_contracts7.BrewSessionDetailResponseSchema.parse(data)
  );
}
...
async function deleteBrewSession(client, brewSessionId) {
  return deleteParsed(client, brewSessionPath(brewSessionId), (data) => import_contracts7.OkResponseSchema.parse(data));
}
...
async function stopBrewSession(client, brewSessionId, body = { reason: "manual" }) {
  const parsedBody = import_contracts7.BrewSessionStopRequestSchema.parse(body);
  return postParsed(
    client,
...
async function patchBrewSessionSteps(client, brewSessionId, body) {
  const parsedBody = import_contracts7.BrewSessionStepsPatchRequestSchema.parse(body);
  return patchParsed(
    client,
    `${brewSessionPath(brewSessionId)}/steps`,
    parsedBody,
    (data) => import_contracts7.BrewSessionStepsResponseSchema.parse(data)
  );
}
...
async function postBrewSessionStepLog(client, brewSessionId, stepId, body) {
  const parsedBody = import_contracts7.BrewSessionStepLogRequestSchema.parse(body);
  return postParsed(
    client,
    `${brewSessionPath(brewSessionId)}/steps/${encodeURIComponent(stepId)}/log`,
    parsedBody,
    (data) => import_contracts7.BrewSessionStepResponseSchema.parse(data)
  );
}
...
async function listBrewSessionIntegrationAttachments(client, brewSessionId) {
  return getParsed(
    ...
    (data) => import_contracts7.IntegrationAttachmentsResponseSchema.parse(data)
  );
}
async function listBrewSessionIntegrationReadings(client, brewSessionId, params) {
  const parsed = import_contracts7.IntegrationReadingsQuerySchema.parse(params);
  const sp = new URLSearchParams();
  ...
  return getParsed(
    ...
    (data) => import_contracts7.IntegrationReadingsResponseSchema.parse(data)
  );
}
async function attachBrewSessionIntegration(client, brewSessionId, body) {
  const parsedBody = import_contracts7.IntegrationAttachRequestSchema.parse(body);
  return postParsed(
    client,
    `${brewSessionPath(brewSessionId)}/integrations/attach`,
    parsedBody,
    (data) => import_contracts7.IntegrationAttachResponseSchema.parse(data)
  );
}
async function detachBrewSessionIntegration(client, brewSessionId, body) {
  const parsedBody = import_contracts7.IntegrationDetachRequestSchema.parse(body);
  return postParsed(
    client,
    `${brewSessionPath(brewSessionId)}/integrations/detach`,
    parsedBody,
    (data) => import_contracts7.IntegrationDetachResponseSchema.parse(data)
  );
}
...
async function listInventory(client) {
  return getParsed(
    ...
    (data) => import_contracts8.InventoryListResponseSchema.parse(data)
  );
}
async function createInventoryItem(client, body) {
  const parsedBody = import_contracts8.InventoryCreateRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/inventory"),
    parsedBody,
    (data) => import_contracts8.InventoryItemResponseSchema.parse(data)
  );
}
async function patchInventoryItem(client, itemId, body) {
  const parsedBody = import_contracts8.InventoryPatchRequestSchema.parse(body);
  return patchParsed(
    client,
...
async function deleteInventoryItem(client, itemId) {
  return deleteParsed(
    client,
    toClientPath(`/inventory/${encodeURIComponent(itemId)}`),
    (data) => import_contracts8.OkResponseSchema.parse(data)
  );
}

// src/brewery/equipmentProfiles.ts
var import_contracts9 = require("@umbraculum/contracts");
async function listEquipmentProfiles(client) {
  return getParsed(
    client,
    toClientPath("/equipment-profiles"),
    (data) => import_contracts9.EquipmentProfilesListResponseSchema.parse(data)
  );
}
async function createEquipmentProfile(client, body) {
  const parsedBody = import_contracts9.EquipmentProfileCreateRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/equipment-profiles"),
    parsedBody,
    (data) => import_contracts9.EquipmentProfileResponseSchema.parse(data)
  );
}
async function patchEquipmentProfile(client, profileId, body) {
  const parsedBody = import_contracts9.EquipmentProfilePatchRequestSchema.parse(body);
  return patchParsed(
    client,
...
async function deleteEquipmentProfile(client, profileId) {
  return deleteParsed(
    client,
    toClientPath(`/equipment-profiles/${encodeURIComponent(profileId)}`),
    (data) => import_contracts9.OkResponseSchema.parse(data)
  );
}

// src/brewery/brewdaySettings.ts
var import_contracts10 = require("@umbraculum/contracts");
async function getBrewdaySettings(client) {
  return getParsed(
    client,
    toClientPath("/brewday-settings"),
    (data) => import_contracts10.BrewdaySettingsResponseSchema.parse(data)
  );
}
async function patchBrewdaySettings(client, body) {
  const parsedBody = import_contracts10.BrewdaySettingsPatchRequestSchema.parse(body);
  return patchParsed(
    client,
    toClientPath("/brewday-settings"),
    parsedBody,
...
var import_contracts11 = require("@umbraculum/contracts");
async function getRecipeWaterHubSummary(client, recipeId) {
  return getParsed(
    ...
    import_contracts11.parseRecipeWaterHubSummaryResponse
  );
}

// src/brewery/waterCalc.ts
var import_contracts12 = require("@umbraculum/contracts");
function postWithDerivation(client, path, payload) {
  return postParsed(
    client,
    toClientPath(path),
    payload,
    (data) => import_contracts12.WaterCalcWithDerivationResponseSchema.parse(data)
  );
}
function postResultOnly(client, path, payload) {
  return postParsed(
    ...
    toClientPath(path),
    payload,
    (data) => import_contracts12.WaterCalcResultOnlyResponseSchema.parse(data)
  );
}
...
var import_contracts13 = require("@umbraculum/contracts");
async function computeAndSaveMash(client, recipeId, payload) {
  return postParsed(
    ...
    payload,
    import_contracts13.parseMashComputeAndSaveResponse
  );
}
async function computeAndSaveSparge(client, recipeId, payload) {
  return postParsed(
    ...
    payload,
    import_contracts13.parseSpargeComputeAndSaveResponse
  );
}
async function computeAndSaveBoil(client, recipeId, payload) {
  return postParsed(
    ...
    payload,
    import_contracts13.parseBoilComputeAndSaveResponse
  );
}

// src/brewery/waterProfiles.ts
var import_contracts14 = require("@umbraculum/contracts");
async function listWaterProfiles(client) {
  return getParsed(client, toClientPath("/water-profiles"), import_contracts14.parseWaterProfilesResponse);
}
async function createWaterProfile(client, body) {
  const parsedBody = import_contracts14.WaterProfileCreateRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/water-profiles"),
    parsedBody,
    (data) => import_contracts14.WaterProfileResponseSchema.parse(data)
  );
}
async function verifyWaterProfile(client, profileId) {
  return postParsed(
    ...
    {},
    (data) => import_contracts14.OkResponseSchema.parse(data)
  );
}
...
var import_contracts15 = require("@umbraculum/contracts");
async function getRecipeWaterSettings(client, recipeId) {
  return getParsed(
    client,
    toClientPath(`/recipes/${encodeURIComponent(recipeId)}/water-settings`),
    (data) => import_contracts15.RecipeWaterSettingsGetResponseSchema.parse(data)
  );
}
async function updateRecipeWaterSettings(client, recipeId, patch) {
  return putParsed(
    ...
    toClientPath(`/recipes/${encodeURIComponent(recipeId)}/water-settings`),
    patch,
    (data) => import_contracts15.RecipeWaterSettingsPutResponseSchema.parse(data)
  );
}
