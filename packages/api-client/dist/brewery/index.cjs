...
async function listStyles(client) {
  return getParsed(client, toClientPath("/styles"), (data) => import_contracts2.StylesListResponseSchema.parse(data));
}
...
function ingredientsQueryString(params) {
  if (!params) return "";
  const parsed = import_contracts3.IngredientsSearchQuerySchema.parse(params);
...
async function searchFermentables(client, params) {
  return getParsed(
    ...
    (data) => import_contracts3.FermentablesListResponseSchema.parse(data)
  );
}
async function searchHops(client, params) {
  return getParsed(
    ...
    (data) => import_contracts3.HopsListResponseSchema.parse(data)
  );
}
async function searchYeasts(client, params) {
  return getParsed(
    ...
    (data) => import_contracts3.YeastsListResponseSchema.parse(data)
  );
}
...
async function previewRecipeImport(client, body) {
  const parsedBody = import_contracts4.RecipeImportRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/recipes/import/preview"),
    parsedBody,
    (data) => import_contracts4.RecipeImportPreviewResponseSchema.parse(data)
  );
}
async function importRecipe(client, body) {
  ...
  return postParsed(
    ...
    parsedBody,
    (data) => import_contracts4.RecipeImportResponseSchema.parse(data)
  );
}
async function previewBulkRecipeImport(client, body) {
  const parsedBody = import_contracts4.RecipeBulkImportRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/recipes/import/bulk/preview"),
    parsedBody,
    (data) => import_contracts4.RecipeBulkImportPreviewResponseSchema.parse(data)
  );
}
async function importRecipesBulk(client, body) {
  ...
  return postParsed(
    ...
    parsedBody,
    (data) => import_contracts4.RecipeBulkImportResponseSchema.parse(data)
  );
}
...
async function getBrewSession(client, brewSessionId) {
  return getParsed(
    ...
    (data) => import_contracts5.BrewSessionDetailResponseSchema.parse(data)
  );
}
...
async function deleteBrewSession(client, brewSessionId) {
  return deleteParsed(client, brewSessionPath(brewSessionId), (data) => import_contracts5.OkResponseSchema.parse(data));
}
...
async function stopBrewSession(client, brewSessionId, body = { reason: "manual" }) {
  const parsedBody = import_contracts5.BrewSessionStopRequestSchema.parse(body);
  return postParsed(
    client,
...
async function patchBrewSessionSteps(client, brewSessionId, body) {
  const parsedBody = import_contracts5.BrewSessionStepsPatchRequestSchema.parse(body);
  return patchParsed(
    client,
    `${brewSessionPath(brewSessionId)}/steps`,
    parsedBody,
    (data) => import_contracts5.BrewSessionStepsResponseSchema.parse(data)
  );
}
...
async function postBrewSessionStepLog(client, brewSessionId, stepId, body) {
  const parsedBody = import_contracts5.BrewSessionStepLogRequestSchema.parse(body);
  return postParsed(
    client,
    `${brewSessionPath(brewSessionId)}/steps/${encodeURIComponent(stepId)}/log`,
    parsedBody,
    (data) => import_contracts5.BrewSessionStepResponseSchema.parse(data)
  );
}
...
async function listBrewSessionIntegrationAttachments(client, brewSessionId) {
  return getParsed(
    ...
    (data) => import_contracts5.IntegrationAttachmentsResponseSchema.parse(data)
  );
}
async function listBrewSessionIntegrationReadings(client, brewSessionId, params) {
  const parsed = import_contracts5.IntegrationReadingsQuerySchema.parse(params);
  const sp = new URLSearchParams();
  ...
  return getParsed(
    ...
    (data) => import_contracts5.IntegrationReadingsResponseSchema.parse(data)
  );
}
async function attachBrewSessionIntegration(client, brewSessionId, body) {
  const parsedBody = import_contracts5.IntegrationAttachRequestSchema.parse(body);
  return postParsed(
    client,
    `${brewSessionPath(brewSessionId)}/integrations/attach`,
    parsedBody,
    (data) => import_contracts5.IntegrationAttachResponseSchema.parse(data)
  );
}
async function detachBrewSessionIntegration(client, brewSessionId, body) {
  const parsedBody = import_contracts5.IntegrationDetachRequestSchema.parse(body);
  return postParsed(
    client,
    `${brewSessionPath(brewSessionId)}/integrations/detach`,
    parsedBody,
    (data) => import_contracts5.IntegrationDetachResponseSchema.parse(data)
  );
}
...
async function listInventory(client) {
  return getParsed(
    ...
    (data) => import_contracts6.InventoryListResponseSchema.parse(data)
  );
}
async function createInventoryItem(client, body) {
  const parsedBody = import_contracts6.InventoryCreateRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/inventory"),
    parsedBody,
    (data) => import_contracts6.InventoryItemResponseSchema.parse(data)
  );
}
async function patchInventoryItem(client, itemId, body) {
  const parsedBody = import_contracts6.InventoryPatchRequestSchema.parse(body);
  return patchParsed(
    client,
...
async function deleteInventoryItem(client, itemId) {
  return deleteParsed(
    client,
    toClientPath(`/inventory/${encodeURIComponent(itemId)}`),
    (data) => import_contracts6.OkResponseSchema.parse(data)
  );
}
...
async function listEquipmentProfiles(client) {
  return getParsed(
    ...
    (data) => import_contracts7.EquipmentProfilesListResponseSchema.parse(data)
  );
}
async function createEquipmentProfile(client, body) {
  const parsedBody = import_contracts7.EquipmentProfileCreateRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/equipment-profiles"),
    parsedBody,
    (data) => import_contracts7.EquipmentProfileResponseSchema.parse(data)
  );
}
async function patchEquipmentProfile(client, profileId, body) {
  const parsedBody = import_contracts7.EquipmentProfilePatchRequestSchema.parse(body);
  return patchParsed(
    client,
...
async function deleteEquipmentProfile(client, profileId) {
  return deleteParsed(
    client,
    toClientPath(`/equipment-profiles/${encodeURIComponent(profileId)}`),
    (data) => import_contracts7.OkResponseSchema.parse(data)
  );
}
...
async function getBrewdaySettings(client) {
  return getParsed(
    ...
    (data) => import_contracts8.BrewdaySettingsResponseSchema.parse(data)
  );
}
async function patchBrewdaySettings(client, body) {
  const parsedBody = import_contracts8.BrewdaySettingsPatchRequestSchema.parse(body);
  return patchParsed(
    client,
    toClientPath("/brewday-settings"),
    parsedBody,
...
async function getRecipeWaterHubSummary(client, recipeId) {
  return getParsed(
    ...
    import_contracts9.parseRecipeWaterHubSummaryResponse
  );
}
...
function postWithDerivation(client, path, payload) {
  return postParsed(
    ...
    toClientPath(path),
    payload,
    (data) => import_contracts10.WaterCalcWithDerivationResponseSchema.parse(data)
  );
}
function postResultOnly(client, path, payload) {
  return postParsed(
    ...
    toClientPath(path),
    payload,
    (data) => import_contracts10.WaterCalcResultOnlyResponseSchema.parse(data)
  );
}
...
async function computeAndSaveMash(client, recipeId, payload) {
  return postParsed(
    ...
    payload,
    import_contracts11.parseMashComputeAndSaveResponse
  );
}
async function computeAndSaveSparge(client, recipeId, payload) {
  return postParsed(
    ...
    payload,
    import_contracts11.parseSpargeComputeAndSaveResponse
  );
}
async function computeAndSaveBoil(client, recipeId, payload) {
  return postParsed(
    ...
    payload,
    import_contracts11.parseBoilComputeAndSaveResponse
  );
}
...
async function listWaterProfiles(client) {
  return getParsed(client, toClientPath("/water-profiles"), import_contracts12.parseWaterProfilesResponse);
}
async function createWaterProfile(client, body) {
  const parsedBody = import_contracts12.WaterProfileCreateRequestSchema.parse(body);
  return postParsed(
    client,
    toClientPath("/water-profiles"),
    parsedBody,
    (data) => import_contracts12.WaterProfileResponseSchema.parse(data)
  );
}
async function verifyWaterProfile(client, profileId) {
  return postParsed(
    ...
    {},
    (data) => import_contracts12.OkResponseSchema.parse(data)
  );
}
...
async function getRecipeWaterSettings(client, recipeId) {
  return getParsed(
    ...
    (data) => import_contracts13.RecipeWaterSettingsGetResponseSchema.parse(data)
  );
}
async function updateRecipeWaterSettings(client, recipeId, patch) {
  return putParsed(
    ...
    toClientPath(`/recipes/${encodeURIComponent(recipeId)}/water-settings`),
    patch,
    (data) => import_contracts13.RecipeWaterSettingsPutResponseSchema.parse(data)
  );
}
