...
function HydrometerChart({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_tamagui.YStack, { gap: "$2", marginTop: "$2", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ui.Card, { accessibilityRole: "image", accessibilityLabel: title ?? "Hydrometer chart", children: [
        ...
        import_victory_native.VictoryChart,
        {
          ...
          containerComponent: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_victory_native.VictoryVoronoiContainer,
            {
              ...
              labelComponent: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_victory_native.VictoryTooltip, { cornerRadius: 4, flyoutPadding: { top: 6, bottom: 6, left: 8, right: 8 } })
            }
          ),
          children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_tamagui.XStack, { gap: "$3", flexWrap: "wrap", marginTop: "$2", children: [
