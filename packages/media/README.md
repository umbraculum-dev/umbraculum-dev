...
- **Depends on**: nothing in the workspace scope. This package is at the bottom of the package dependency stack alongside `@umbraculum/i18n` and `@umbraculum/contracts` (both pending sub-plan #9 renames).
