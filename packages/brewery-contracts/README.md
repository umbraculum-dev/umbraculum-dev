...
| Client transport | Consumed by [`packages/api-client/src/brewery/`](../../packages/api-client/src/brewery/) for runtime-validated fetch helpers. |
...
- [`packages/api-client/src/brewery/`](../../packages/api-client/src/brewery/) — typed client helpers.
