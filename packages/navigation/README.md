...
- **Depends on**: nothing in `@brewery/*`. This package is at the bottom of the `@brewery/*` dependency stack alongside `@brewery/i18n`, `@brewery/contracts`, and `@brewery/media`.
