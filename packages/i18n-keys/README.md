...
- [`packages/module-sdk/README.md`](../module-sdk/README.md) — `registerWebModule` / `registerNativeModule`
- [`packages/i18n/README.md`](../i18n/README.md) — where locale JSON lives today
