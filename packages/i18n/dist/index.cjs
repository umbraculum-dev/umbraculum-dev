...
var en_default = {
  ...
  recipes: {
    title: "Recipes",
    subtitle: "This is the recipe area entrypoint (list/edit/water calculator).",
    import: {
      title: "Import recipe",
  ...
  waterProfiles: {
    ...
    activeAccount: "Active account",
    viewAllTableTitle: "View all water profiles (table)",
  ...
  waterHub: {
    ...
    quickStatus: "Quick status (read-only)",
...
var it_default = {
  ...
  waterProfiles: {
    ...
    activeAccount: "Account attivo",
    viewAllTableTitle: "Vedi tutti i profili acqua (tabella)",
  ...
  waterHub: {
    ...
    quickStatus: "Stato rapido (sola lettura)",
