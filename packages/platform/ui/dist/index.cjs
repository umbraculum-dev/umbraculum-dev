          ...
          import_tamagui7.RadioGroup,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_tamagui7.YStack, { gap: "$2", children: options.map((o) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_tamagui7.XStack, { gap: "$2", alignItems: "center", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  import_tamagui7.RadioGroup.Item,
                  {
                    id,
                    value: o.value,
                    size: "$3",
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                      import_tamagui7.RadioGroup.Indicator,
                      {
                        unstyled: true,
                        width: 10,
                        height: 10,
...
function SelectField({
  ...
  const selectedLabel = (0, import_react11.useMemo)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_react_native7.View, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        Button,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Text, { fontSize: 12, children: (renderValue ? renderValue(value) : selectedLabel) || placeholder || "\u2014" })
        }
      ),
...
function useAiChatStream(input) {
  ...
  const [terminalError, setTerminalError] = (0, import_react13.useState)(null);
  const abortRef = (0, import_react13.useRef)(null);
  const applyProposal = (0, import_react13.useCallback)(
    async (proposalId) => {
  ...
  const rejectProposal = (0, import_react13.useCallback)(
    async (proposalId) => {
...
function AiChatPanel({ chat, t, onOpenUpgrade }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
    import_tamagui11.YStack,
    {
      gap: "$4",
      ...{ "aria-labelledby": "ai-chat-title", role: "main" },
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_tamagui11.YStack, { gap: "$2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.H2, { id: "ai-chat-title", children: t("title") }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.SizableText, { size: "$2", theme: "alt2", children: t("subtitle") })
        ] }),
        errorText ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          import_tamagui11.View,
          {
            ...
            ...{ role: "alert" },
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.SizableText, { children: errorText }),
              isSubscriptionError && onOpenUpgrade ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.XStack, { marginTop: "$2", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                Button,
                {
                  size: "$2",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          import_tamagui11.YStack,
          {
            ...
            borderColor: "$borderColor",
            ...{ "aria-live": "polite" },
            children: messages.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.SizableText, { theme: "alt2", children: t("messages.empty") }) : messages.map((m) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_tamagui11.YStack, { gap: "$1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.SizableText, { fontWeight: "600", children: m.role === "user" ? t("messages.you") : t("messages.assistant") }),
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.SizableText, { children: m.text || (pending && m.role === "assistant" ? t("composer.thinking") : "") }),
              m.turn?.toolCalls.map((tc, i) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.SizableText, { size: "$1", theme: "alt2", children: tc.errored ? t("messages.toolError", { message: tc.name }) : t("messages.toolCall", { tool: tc.name }) }, `${m.id}-tc-${i}`)),
              m.turn?.proposals.map((p) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
                import_tamagui11.YStack,
                {
                  gap: "$2",
                  padding: "$2",
                  ...
                  borderRadius: "$2",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.SizableText, { size: "$2", children: p.summary }),
                    p.status === "pending" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_tamagui11.XStack, { gap: "$2", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                        Button,
                        {
                          size: "$2",
                    ...
                    ] }) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.SizableText, { size: "$1", theme: "alt2", children: p.status === "applied" ? t("proposals.applied") : t("proposals.dismissed") })
                  ]
                },
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_tamagui11.XStack, { gap: "$2", alignItems: "center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_tamagui11.View, { flex: 1, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            Input,
            {
              value: draft,
