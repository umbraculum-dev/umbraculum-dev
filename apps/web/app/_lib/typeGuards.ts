/**
 * Local apps/web type guards.
 *
 * Mirrors the project-local hand-rolled validation strategy described in
 * `docs/CONTRACTS-VALIDATION-STRATEGY.md`: when a payload is `unknown`, narrow it
