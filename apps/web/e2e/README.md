...
- **Contains**: cross-page user-flow specs (platform, canonical, verticals-brewery projects), persona-aware Playwright fixtures, centralized role/label locators (per the accessibility mandate in [`docs/DEVELOPMENT-ACCESSIBILITY.md`](../../../docs/DEVELOPMENT-ACCESSIBILITY.md)), axe-core a11y helpers, persisted per-persona storage state, HTML reporter wiring.
...
- [`docs/design/pre-flip-application-surface-backbone.md`](../../../docs/design/pre-flip-application-surface-backbone.md) §5 — E2E taxonomy
